...
/******/ (() => {
    /******/ var __webpack_modules__ = ({
        ...
        /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
            ...
            const bodyParser = __nccwpck_require__(649);
            const cookieParser = __nccwpck_require__(9266);
            const defaultMaxSize = '100kb'; // body-parser default
            const jsonLimit = process.env.MAX_JSON_SIZE || defaultMaxSize;
            module.exports = async function (fastify, options) {
                for (const method of ['DELETE', 'GET', 'PATCH', 'POST', 'PUT', 'OPTIONS'])
                    fastify.route({
                        method,
                        url: '*',
                ...
                fastify.register(__nccwpck_require__(5856))
                    .after(() => {
        ...
        /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
            "use strict";
            const fp = __nccwpck_require__(1180);
            const symbols = __nccwpck_require__(9281);
            const Express = __nccwpck_require__(4616);
        ...
        /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
            ...
            var signature = __nccwpck_require__(9577);
            /**
             * Module exports.
             * @public
             */
        ...
        /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
            ...
            var cookie = __nccwpck_require__(6037);
        ...
        /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
            "use strict";
            const extractPluginName = __nccwpck_require__(6022);
            let count = 0;
        ...
        /***/ ((__unused_webpack_module, exports, __nccwpck_require__) => {
            ...
            DBCSDecoder.prototype.write = function (buf) {
                var newBuf = Buffer.alloc(buf.length * 2), nodeIdx = this.nodeIdx, prevBuf = this.prevBuf, prevBufOffset = this.prevBuf.length, seqStart = -this.prevBuf.length, // idx of the start of current parsed sequence.
                uCode;
        ...
        /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
            ...
            var Buffer = (__nccwpck_require__(9990).Buffer);
            var bomHandling = __nccwpck_require__(1090), iconv = module.exports;
        ...
        /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
            "use strict";
            var Buffer = (__nccwpck_require__(4300).Buffer), Transform = (__nccwpck_require__(2781).Transform);
            // == Exports ==================================================================
            module.exports = function (iconv) {
