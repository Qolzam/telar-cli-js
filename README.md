...
running command...
$ telar (--version)
telar-cli/0.20.26 darwin-arm64 node-v21.5.0
$ telar --help [COMMAND]
USAGE
  $ telar COMMAND
...
...
* [`telar solution [COMMAND] [SERVICE]`](#telar-solution-command-service)
...
_See code: [src/commands/create.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.20.26/src/commands/create.ts)_
...
_See code: [src/commands/html.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.20.26/src/commands/html.ts)_
...
_See code: [src/commands/platform.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.20.26/src/commands/platform.ts)_
...
_See code: [src/commands/run.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.20.26/src/commands/run.ts)_
...
_See code: [src/commands/seal.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.20.26/src/commands/seal.ts)_
...
_See code: [src/commands/service.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.20.26/src/commands/service.ts)_
...
_See code: [src/commands/solution.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.20.26/src/commands/solution.ts)_
...
_See code: [src/commands/sync.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.20.26/src/commands/sync.ts)_
<!-- commandsstop -->
