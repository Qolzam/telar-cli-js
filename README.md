...
running command...
$ telar (--version)
telar-cli/0.11.0 darwin-arm64 node-v16.13.1
$ telar --help [COMMAND]
USAGE
  $ telar COMMAND
...
...
_See code: [dist/commands/html.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.11.0/dist/commands/html.ts)_
...
_See code: [dist/commands/platform.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.11.0/dist/commands/platform.ts)_
...
_See code: [dist/commands/proxy.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.11.0/dist/commands/proxy.ts)_
...
_See code: [dist/commands/run.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.11.0/dist/commands/run.ts)_
...
_See code: [dist/commands/sync.ts](https://github.com/Qolzam/telar-cli-js/blob/v0.11.0/dist/commands/sync.ts)_
<!-- commandsstop -->
